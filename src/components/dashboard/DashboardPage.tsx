...
export default function DashboardPage() {
                    ...
                    <div className="p-8 max-w-7xl mx-auto space-y-10">
                        <section>
                            <div className="mb-6 flex justify-between items-end">
                                <div>
                                    <h1 className="text-3xl font-bold text-[var(--color-text-primary)]">Hi!</h1>
                                    <p className="text-[var(--color-text-secondary)] mt-1">Here is a snapshot of your finances today.</p>
                                </div>
    ...
    return (
        <div className="flex h-screen font-sans selection:bg-[var(--color-accent)]/20">
            {/* Sidebar */}
            <aside className="w-64 border-r border-white/5 bg-[var(--color-bg-secondary)]/80 backdrop-blur-xl flex flex-col p-6 hidden lg:flex">
            ...
            <main className="flex-1 overflow-y-auto">
                <header className="px-8 py-6 border-b border-white/5 bg-[var(--color-bg-primary)]/60 backdrop-blur-xl sticky top-0 z-30 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <h2 className="text-lg font-black uppercase tracking-wider">{activeTab}</h2>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <button className="p-2.5 text-[var(--color-text-secondary)] hover:bg-white/5 rounded-xl transition-all relative">
                        ...
                        <button
                            ...
                            className="btn-primary !py-2 !px-4 text-sm font-bold flex items-center gap-2"
                        >
